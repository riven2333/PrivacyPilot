    ...
    def makeFunnel(
        ...
        if direction == "horizontal":
            ...
            if funnelLabelPosition == "before":
                ...
                funnelBodyRectangle = Rectangle(
                    renderingRectangle.top,
                    renderingRectangle.left + int(renderingRectangle.width * funnelLabelsProportion),
                    renderingRectangle.height,
                ...
                funnelLabelsRectangle = Rectangle(
                    renderingRectangle.top,
                    renderingRectangle.left + renderingRectangle.width * (1 - funnelLabelsProportion),
                    renderingRectangle.height,
                    int(renderingRectangle.width * funnelLabelsProportion),
                )
        ...
        # Create the labels
        for i, label in enumerate(funnelLabels):
            if direction == "horizontal":
                tb = slide.shapes.add_textbox(
                    funnelLabelsRectangle.left + i * partWidth,
                ...
                tb = slide.shapes.add_textbox(
                    ...
                    funnelLabelsRectangle.top + i * partHeight,
            ...
            if direction == "horizontal":
                ...
                if (
                    ...
                    rightSpaceAboveBelow = (
                        (funnelBodyRectangle.height - tipHeight) / 2 * (b + 1) / (funnelPartCount - 1)
                    )

                else:
                    # Calculate space to be above and below left end of stage
                    leftSpaceAboveBelow = (
                        (funnelBodyRectangle.height - tipHeight) / 2 * (funnelPartCount - b) / (funnelPartCount - 1)
                    )

                    # Calculate space to be above and below right end of stage
                    rightSpaceAboveBelow = (
                        (funnelBodyRectangle.height - tipHeight) / 2 * (funnelPartCount - b - 1) / (funnelPartCount - 1)
                    )
                ...
                if (
                    ...
                    topSpaceLeftRight = (funnelBodyRectangle.width - tipWidth) / 2 * b / (funnelPartCount - 1)

                    # Calculate space to be left at left and right bottom end of stage
                    bottomSpaceLeftRight = (funnelBodyRectangle.width - tipWidth) / 2 * (b + 1) / (funnelPartCount - 1)

                else:
                    # Calculate space to be left at left and right top end of stage
                    topSpaceLeftRight = (
                        (funnelBodyRectangle.width - tipWidth) / 2 * (funnelPartCount - b) / (funnelPartCount - 1)
                    )

                    # Calculate space to be left at left and right bottom end of stage
                    bottomSpaceLeftRight = (
                        (funnelBodyRectangle.width - tipWidth) / 2 * (funnelPartCount - b - 1) / (funnelPartCount - 1)
                    )
                ...
                partTopRight = funnelBodyRectangle.left + funnelBodyRectangle.width - topSpaceLeftRight

                # Calculate x coordinate of bottom right corner
                partBottomRight = funnelBodyRectangle.left + funnelBodyRectangle.width - bottomSpaceLeftRight
